                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                    ...
                    <div class="notification-list">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex">
                                <img class="d-flex me-2 rounded-circle"
                                    src="{{ asset("dist/assets/images/users/avatar-2.jpg") }}"
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex">
                                <img class="d-flex me-2 rounded-circle"
                                    src="{{ asset("dist/assets/images/users/avatar-5.jpg") }}"
                                    alt="Generic placeholder image" height="32">
                                <div class="w-100">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0">
                    ...
                    <div class="p-2">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col">
                                <a class="dropdown-icon-item" href="#">
                                    <img src="{{ asset("dist/assets/images/brands/behance.png") }}" alt="Behance">
                                    <span>Behance</span>
                                </a>
                            </div>
                        </div> <!-- end row-->
            ...
            <li class="dropdown me-md-2">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#"
                    ...
                    <span class="account-user-avatar">
                        <img src="{{ asset("dist/assets/images/users/avatar-1.jpg") }}" alt="user-image"
                            width="32" class="rounded-circle">
                    </span>
                    <span class="d-lg-flex flex-column gap-1 d-none">
                        <h5 class="my-0">{{ Auth::user()->name }}</h5>
                        <h6 class="my-0 fw-normal">{{ Auth::user()->getRoleNames()->first() ?? "User" }}</h6>
                    </span>
                </a>
