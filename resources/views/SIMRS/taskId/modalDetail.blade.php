...
<div id="log-taskid-modal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="log-taskid-modalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg"> <!-- pakai modal-xl untuk tabel -->
        <div class="modal-content">
            <div class="modal-header modal-colored-header bg-info">
                <h4 class="modal-title" id="log-taskid-modalLabel">Log Task Id</h4>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body">
